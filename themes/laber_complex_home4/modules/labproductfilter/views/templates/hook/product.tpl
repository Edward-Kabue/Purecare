  ...
  <div class="laberProduct-container">
	  <div class="laberProduct-image">
		...
		{if isset($product.new) && $product.new == 1}
				<span class="laberNew-label">{l s='New' d='Modules.LABProductfilter'}</span>
			{/if}
		{if isset($product.specific_prices) && $product.specific_prices && isset($product.specific_prices.reduction) && $product.specific_prices.reduction > 0}
				<span class="laberSale-label">{l s='Sale' d='Modules.LABProductfilter'}</span>
			{/if}
		
		<div class="laberActions">
			<div class="laberActions-i">
				<div class="laberItem pull-left">		
					<a href="{$product.url}" class="Details" title="{l s='Details' d='Modules.LABProductfilter'}">
						<i class="ion-ios-eye-outline"></i>
					</a>
				</div>
				<div class="laberQuick laberItem pull-left">
				  <a href="#" class="quick-view" data-link-action="quickview">
					<i class="fa fa-search"></i><span>{l s='Quickview' d='Modules.LABProductfilter'}</span>
				  </a>
				</div>
				<div class="laberItem pull-left">
	  ...
	  <div class="laberCart">
			{if ($product.allow_oosp || $product.quantity > 0)}
				...
				<button data-button-action="add-to-cart" class="laberBottom" >
					<i class="fa fa-shopping-cart" aria-hidden="true"></i><span>{l s='Add to cart' d='Modules.LABProductfilter'}</span>
				</button>
				</form>
			{else}
				<form action="{$urls.pages.cart}" method="post">
				...
				<button data-button-action="add-to-cart" class="laberBottom disabled" disabled >
					<i class="fa fa-times" aria-hidden="true"></i><span>{l s='Out of stock' d='Modules.LABProductfilter'}</span>
				</button>
				</form>
			{/if}
		</div>
