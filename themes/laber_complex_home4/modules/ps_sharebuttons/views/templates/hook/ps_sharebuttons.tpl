...
{block name='social_sharing'}
  {if $social_share_links}
    <div class="laberSocial-sharing laber-media-body">
      <span class="labeTitle pull-left">{l s='Share' d='Shop.Theme.Actions'}</span>
      <ul class="pull-left">
        {foreach from=$social_share_links item='social_share_link'}
			{if $social_share_link.class =='facebook'} 
				<li class="laber{$social_share_link.class} pull-left icon-gray">
					<a href="{$social_share_link.url}"  title="{$social_share_link.label}" target="_blank">
						<i class="fa fa-facebook"></i></a></li>
			{/if}
			{if $social_share_link.class =='twitter'} 
				<li class="laber{$social_share_link.class} pull-left icon-gray"><a href="{$social_share_link.url}"  title="{$social_share_link.label}" target="_blank">
