...
<div class="product-line-grid row">
  ...
  <div class="product-line-grid-body col-md-4 col-xs-8">
    <div class="product-line-info">
      <a class="label" href="{$product_link}" data-id_customization="{$product.id_customization|intval}">{$product.name}</a>
    </div>
    ...
    {if isset($product.instructions) && $product.instructions}<a href="{$product_link}">
      {$product.instructions|escape:'htmlspecialchars':'UTF-8' nofilter}</a>
          ...
          <div class="col-md-6 col-xs-6 qty">
            ...
            {else}
              <input
                ...
                data-down-url="{$product.down_quantity_url}&special_instructions={$product.instructions_valid}&special_instructions_id={$product.instructions_id}"
                data-up-url="{$product.up_quantity_url}&special_instructions={$product.instructions_valid}&special_instructions_id={$product.instructions_id}"
                data-update-url="{$product.update_quantity_url}&special_instructions={$product.instructions_valid}&special_instructions_id={$product.instructions_id}"
