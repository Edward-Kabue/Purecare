	  ...
	  {block name='product_cover'}
		...
		<div class="product-cover slider-for">
		 ...
		 <div class="thumb-item">
		  ...
		  <a href="{$image.bySize.combination.url}">
		   <img class=""  style="width:100%;" src="{$image.bySize.combination.url}" alt="{$image.legend}" title="{$image.legend}" itemprop="image">
		  </a>
		  </div>

		  {else}
			<img src="{$urls.no_picture_image.bySize.combination.url}" style="width:100%;">
		  {/if}
		   </div>
		 {/foreach}
		</div>
