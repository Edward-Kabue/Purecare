		...
		<div class="laber-mediaBody">
			...
			<div class="laber-content laber-mediaBody">
				...
				<div class="product-quick-view">		
					<a href="javascript:void(0);" class="quick-view quickview" data-toggle="tooltip" data-placement="top" data-link-action="quickview" title="quickview" >
						<i class="fa fa-search" aria-hidden="true"></i>	
						<span class="text">{l s='Quick view' d='Modules.LABProductCategory'}</span>
					</a>
				</div>							
			 </div>
		</div>	
