	...
	<div class="{$product_group.class|escape:'html':'UTF-8'} laberProductFilter laberProductGrid clearfix">
		...
		<div class="prod-filter labContent">
					...
					<div class="owl-buttons">
						<p class="owl-prev prev-{$product_group.class|escape:'html':'UTF-8'}"><i class="fa fa-angle-left"></i></p>
						<p class="owl-next next-{$product_group.class|escape:'html':'UTF-8'}"><i class="fa fa-angle-right"></i></p>
					</div>
					{/if}
					{else}
