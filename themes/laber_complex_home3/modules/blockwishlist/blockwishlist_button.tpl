    ...
    <div class="wishlist product-item-wishlist">
    	...
    	{foreachelse}
    		<a href="#" id="wishlist_button_nopop" onclick="WishlistCart('wishlist_block_list', 'add', '{$id_product|intval}', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="{l s='Add to my wishlist' mod='blockwishlist'}">
    			<i class="mdi mdi-heart-outline"></i> {l s='Add to wishlist' mod='blockwishlist'}
    		</a>
    	{/foreach}
	</div>
{else}
<div class="laberwishlist product-item-wishlist">
	<a class="addToWishlist wishlistProd_{$product.id_product|intval}" title="{l s='Add to wishlist' mod='blockwishlist'}" href="#" rel="{$product.id_product|intval}" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', false, 1); return false;">
		<i class="ion-android-favorite-outline"></i> <span>{l s='Add to wishlist' mod='blockwishlist'}</span>
	</a>
</div>
{/if}