...
<div class="laberContent-prod laberProductGrid">
<div class="block-content clearfix">
	<div id="laberProd-cat-{$cat_info.id_cat|intval}">
		<div class="laberCateTitle">
			<h3 {if $cat_info.cat_color }style="background:{$cat_info.cat_color}{/if}">
		...
		<div class="laberCateProducts">
			...
			<div class="laberContentProduct laberContentProduct-{$cat_info.id_cat}-{$group_cat.id_labgroupcategory} clearfix">
				...
				<div class="laberContainer" id="laber-{$smarty.foreach.g_cat_info.iteration|escape:'html':'UTF-8'}">	
						<div class="laberProducts-Grid row">
							<div id="laberOWL-{$smarty.foreach.g_cat_info.iteration|intval}" class="Laber-product-list">
...
{foreach from=$group_cat_info item=cat_info name=g_cat_info}
	{if $group_cat.use_slider == 1}	
		...
		$(document).ready(function() {
			var owl = $("#laberOWL-{$smarty.foreach.g_cat_info.iteration|intval}");
			owl.owlCarousel({
				items : 4,
				itemsDesktop : [1199,3],
