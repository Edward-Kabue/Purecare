...
class labslideshow extends Module
{
	...
	protected function createTables()
	{
        ...
        $sql1 = "INSERT INTO `"._DB_PREFIX_."labslideshow_slides_lang` (`id_labslideshow_slides`, `id_lang`, `title`, `description`, `legend`, `url`, `image`) VALUES
			('1','1','banner','','banner','#','a7044e0cfc565966f345f5e970f52a1f23d49c95_banner_3_1.png'),
			('1','2','banner','','banner','#','f8b870c5e838ee5f4743dd50bfc61765ad2a973b_banner_3_1.png'),
			('2','1','banner','','banner','#','2f464331f248d96e0c33706a0f31f25f0637b550_banner_3_2.png'),
			('2','2','banner','','banner','#','9b08f82739ed4f51f388c08880bc0d83501edcda_banner_3_2.png'),
			('3','1','banner','','banner','#','2a6823390c54856c3712523d23c49fba79553836_banner_3_3.png'),
			('3','2','banner','','banner','#','594183211d2b4ddd128974ce334eaf887d1c90b1_banner_3_3.png')
