...
class LabVegamenuItemClass extends ObjectModel
{
	public $id_column;
	public $type_link;
	public $type_item;
	...
	public	function __construct($id_item = null, $id_lang = null, $id_shop = null, Context $context = null)
	{
		...
		Shop::addTableAssociation('labvegamenu_item', array('type' => 'shop'));
		Shop::addTableAssociation('labvegamenu_item_lang', array('type' => 'fk_shop'));
		if ($this->id)
		{
	...
	public function getFieldShop($field)
	{
		...
		$sql = 'SELECT wms.'.$field.' FROM '._DB_PREFIX_.'labvegamenu_item wm
		LEFT JOIN '._DB_PREFIX_.'labvegamenu_item_shop wms ON (wm.id_item = wms.id_item)
	...
	public function getPositionByMenuItem($id_menu_item)
	{
		...
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->getRow('
			SELECT ms.`position`
			FROM '._DB_PREFIX_.'labvegamenu_item_shop ms
