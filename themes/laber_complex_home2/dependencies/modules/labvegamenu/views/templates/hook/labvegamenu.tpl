...
{$id_lang = Context::getContext()->language->id}
	...
	<div class="title-menu"><span>{l s='Vertical menu' d='Modules.LABVegamenu'}</span></div>
	...
	<script type="text/javascript">
		...
		text_more = "{l s='More' d='Modules.LABVegamenu'}";
		numLiItem = $("#lab-menu-vertical .menu-content li.level-1").length;
		nIpadHorizontal = 6;
		nIpadVertical = 5;
