...
class SampleDataHtml
{
	public function initData($base_url)
	{
		...
		$content_block2 = '
			<div class="laberStatic laber-col-md-3">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_2_1.png" alt="images" /> </a></div>
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_2_2.png" alt="images" /> </a></div>
			</div>
		';
		...
		$result &= Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'labcustomhtml` (`id_labcustomhtml`, `hook`, `active`) 
			VALUES
			(1, "displayImageSlider", 1),
			(2, "displayPosition1", 1),
			(3, "displayPosition2", 1),
		...
		foreach (Language::getLanguages(false) as $lang)
		{
			...
			VALUES 
			( "1", "'.$id_shop.'","'.$lang['id_lang'].'","Banner ImageSlider", \''.$content_block2.'\'),
			( "2", "'.$id_shop.'","'.$lang['id_lang'].'","banner displayPosition1", \''.$content_block3.'\'),
			( "3", "'.$id_shop.'","'.$lang['id_lang'].'","banner displayPosition2", \''.$content_block4.'\'),
