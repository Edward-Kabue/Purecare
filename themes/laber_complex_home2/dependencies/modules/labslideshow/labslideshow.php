...
class labslideshow extends Module
{
	...
	protected function createTables()
	{
        ...
        $sql1 = "INSERT INTO `"._DB_PREFIX_."labslideshow_slides_lang` (`id_labslideshow_slides`, `id_lang`, `title`, `description`, `legend`, `url`, `image`) VALUES
			('1','1','banner','','banner','#','356736ae169cf9eb7a1e63054a4071fea617d141_banner_2_1.png'),
			('1','2','banner','','banner','#','d6cdf20346e341b77ec0a6c8309fedcd80b1c9fd_banner_2_1.png'),
			('2','1','banner','','banner','#','921cbcc28f6e14c3f14ccce042b4db59e4154a2a_banner_2_2.png'),
			('3','2','banner','','banner','#','b3d3a997c0f6e60c9dd871838c1f488a52176f07_banner_2_2.png'),
			('4','1','banner','','banner','#','3499b9b5946a9726c0639f777e091052c43c321e_banner_2_3.png'),
			('5','2','banner','','banner','#','d6d8dcfda83403bd8f4a8cb972edb69c51495b05_banner_2_3.png')
