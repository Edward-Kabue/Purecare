...
include_once(_PS_MODULE_DIR_.'labproductcategory/sql/SampleDataProdCat.php');

class Labproductcategory extends Module
{
	protected $config_form = false;
	private $html = '';
	private $hook_into = array('displayHome', 'displayPosition1', 'displayPosition2', 'displayPosition3', 'displayPosition4', 'displayPosition5', 'displayPosition6');
	...
	public function __construct()
	{
		...
		$this->bootstrap = true;
		parent::__construct();
		$this->displayName = $this->getTranslator()->trans('LABER Product Category', array(), 'Modules.LABProductCategory.Admin');
		$this->description = $this->getTranslator()->trans('Get product from category to display on the homepage.', array(), 'Modules.LABProductCategory.Admin');
	...
	public function renderListCat()
	{
		...
		$info_cat_item = $this->getCatItemInfo($id_labgroupcategory);
	...
	public function getCatItemInfo($id_gr, $active = null)
	{
		...
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			...
			WHERE pc.id_labgroupcategory = '.$id_gr.' AND pc.id_shop = '.$id_shop.($active ? ' AND pc.`active` = 1' : ' ')
		);
	}
	...
	public function getAddFieldsValues()
	{
		...
		{
			$fields['group_cat'] = Tools::getValue('group_cat', 'Group category');
	...
	{
		$req = 'SELECT lab.`id_labgroupcategory` as id_labgroupcategory
				FROM `'._DB_PREFIX_.'labgroupcategory` lab
				WHERE lab.`id_labgroupcategory` = '.(int)$id;
	...
	public function prevHook($hook_name)
	{
		...
		$group_cat = new LabGroupCategoryClass();
	...
	{
			if (!$this->isCached('labproductcategory_home.tpl', $this->getCacheId('labproductcategory_home')))
			{
			...
			return $this->display(__FILE__, 'labproductcategory_home.tpl', $this->getCacheId('labproductcategory_home'));
	...
	{
		if (!$this->isCached('labproductcategory_position1.tpl', $this->getCacheId('labproductcategory_position1')))
		{
		...
		return $this->display(__FILE__, 'labproductcategory_position1.tpl', $this->getCacheId('labproductcategory_position1'));
	}
	
	public function hookdisplayPosition2()
	{
		if (!$this->isCached('labproductcategory_position2.tpl', $this->getCacheId('labproductcategory_position2')))
		{
		...
		return $this->display(__FILE__, 'labproductcategory_position2.tpl', $this->getCacheId('labproductcategory_position2'));
	}
	
	public function hookdisplayPosition3()
	{
		if (!$this->isCached('labproductcategory_position3.tpl', $this->getCacheId('labproductcategory_position3')))
		{
		...
		return $this->display(__FILE__, 'labproductcategory_position3.tpl', $this->getCacheId('labproductcategory_position3'));
	}
	public function hookdisplayPosition4()
	{
		if (!$this->isCached('labproductcategory_position4.tpl', $this->getCacheId('labproductcategory_position4')))
		{
		...
		return $this->display(__FILE__, 'labproductcategory_position4.tpl', $this->getCacheId('labproductcategory_position4'));
	}
	public function hookdisplayPosition5()
	{
		if (!$this->isCached('labproductcategory_position5.tpl', $this->getCacheId('labproductcategory_position5')))
		{
		...
		return $this->display(__FILE__, 'labproductcategory_position5.tpl', $this->getCacheId('labproductcategory_position5'));
	}
	public function hookdisplayPosition6()
	{
		if (!$this->isCached('labproductcategory_position6.tpl', $this->getCacheId('labproductcategory_position6')))
		{
		...
		return $this->display(__FILE__, 'labproductcategory_position6.tpl', $this->getCacheId('labproductcategory_position6'));
	}
	...
	{
		$this->_clearCache('labproductcategory_bottomhome.tpl');
		$this->_clearCache('labproductcategory_tophome.tpl');
		$this->_clearCache('labproductcategory_topcolumn.tpl');
