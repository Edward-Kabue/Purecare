...
<div class="type-tab laberProductFilter labcolumn laberthemes  clearfix">
	<div class="lab_tab">
		...
		{foreach from = $product_groups item = product_group name = product_group}
			<div id="{$product_group.class|escape:'html':'UTF-8'}_tab" class="{$product_group.class|escape:'html':'UTF-8'} tab-pane {if $smarty.foreach.product_group.first} active{/if}">
				...
				<div class="owl-buttons">
					<p class="owl-prev prev-{$product_group.class|escape:'html':'UTF-8'}-tab"><i class="fa fa-angle-left"></i></p>
					<p class="owl-next next-{$product_group.class|escape:'html':'UTF-8'}-tab"><i class="fa fa-angle-right"></i></p>
				</div>
				{if $use_slider == 1}
