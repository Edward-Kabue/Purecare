...
class SampleDataHtml
{
	public function initData($base_url)
	{
		$content_block1 = '
			...
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_1_1.jpg" alt="images"> </a></div>
			</div>
			<div class=" col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_1_2.jpg" alt="images"> </a></div>
			</div>
			</div>
			</div>
		';
		...
		$content_block4 = '
			...
			<div class="row no-margin">
			<div class=" col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_1_6.jpg" alt="images" /> </a></div>
			</div>
			<div class=" col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_1_7.jpg" alt="images" /> </a></div>
			</div>
			</div>
			</div>
		';
		$content_block5 = '
			<div class="laberStatic laberthemes">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_1_8.jpg" alt="images" /> </a></div>
			</div>
		';													
		...
		$result &= Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'labcustomhtml` (`id_labcustomhtml`, `hook`, `active`) 
			...
			(5, "displayPosition5", 1),
			(6, "displayPosition6", 1),
			(7, "displayLeftColumn", 1),
			(8, "displayFooter", 1),
			(9, "displayFooterAfter", 1),
			(10, "displayFooterAfter", 1)
		...
		foreach (Language::getLanguages(false) as $lang)
		{
			...
			( "5", "'.$id_shop.'","'.$lang['id_lang'].'","banner displayPosition5", \''.$content_block5.'\'),
			( "6", "'.$id_shop.'","'.$lang['id_lang'].'","support", \''.$content_block6.'\'),
			( "7", "'.$id_shop.'","'.$lang['id_lang'].'","Banner displayleftcolumn", \''.$content_block7.'\'),
			( "8", "'.$id_shop.'","'.$lang['id_lang'].'","logo footer and contac", \''.$content_block8.'\'),
			( "9", "'.$id_shop.'","'.$lang['id_lang'].'","Copyright", \''.$content_block9.'\'),
			( "10", "'.$id_shop.'","'.$lang['id_lang'].'","logo payment", \''.$content_block10.'\')
