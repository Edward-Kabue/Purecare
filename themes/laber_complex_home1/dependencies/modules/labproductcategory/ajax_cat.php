...
include_once(dirname(__FILE__).'/labproductcategory.php');
$lab_cat  = new labproductcategory();

	$id_cat = Tools::replaceAccentedChars($_REQUEST['id_Cat']);
	$id_group = Tools::replaceAccentedChars($_REQUEST['id_Group']);
	$use_slider = Tools::replaceAccentedChars($_REQUEST['use_Slider']);
	...
	$productResults = $lab_cat->getProductCat($id_cat, $number_prod);
...
echo $lab_cat->display(dirname(__FILE__).'/labproductcategory.php', 'labproductcategory_accordion_ajax.tpl');
