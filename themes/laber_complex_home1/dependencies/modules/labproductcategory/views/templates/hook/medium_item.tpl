		...
		<div class="product-container">	
					<div class="product-image-container">
						...
						{if isset($product.new) && $product.new == 1}
								<span class="new-label">{l s='New' d='Modules.LABProductCategory'}</span>
							{/if}
						{if isset($product.specific_prices) && $product.specific_prices && isset($product.specific_prices.reduction) && $product.specific_prices.reduction > 0}
								<span class="sale-label">{l s='On sale!' d='Modules.LABProductCategory'}</span>
							{/if}
					...
					<div class="col-right">
						...
						<div class="laber-highlighted-informations">		
							<a href="javascript:void(0);" class="quick-view" data-toggle="tooltip" data-placement="top" data-link-action="quickview" title="quickview" rel="#">
