...
<div class="poslistcategories">
	<div class="pos_title">
		...
		<div class="desc_title">
			{l s='Add Popular Categories to weekly line up' d='Shop.Theme.Catalog'}
		</div>		
	</div>
			...
			{/if}	
				<div class="list-categories">
					...
					<div class="desc-listcategoreis">
					    ...
					    <div class="number_product">{$category.nbProducts} {l s='Products' d='Shop.Theme.Catalog'}</div>
						<div class="view-more"><a href="{$link->getCategoryLink($category['id_category'])}" > {l s='Shop Now' d='Shop.Theme.Catalog'}</a></div>
