    ...
    public function initData()
    {
        ...
        foreach (Language::getLanguages(true, Context::getContext()->shop->id) as $lang) {
            $queries[] = 'INSERT INTO `'._DB_PREFIX_.'pos_staticblock_lang` (`id_pos_staticblock`, `id_lang`, `content`) VALUES
				...
				<div class="box_cms"><img src="/pos_ecolife/img/cms/icon_cms1.png" alt="" class="img-responsive" />
				<div class="txt_cms">
				<h2>Free Shipping</h2>
				...
				<div class="col-cms col-xs-12 col-sm-6 col-md-6 col-lg-3">
				<div class="box_cms"><img src="/pos_ecolife/img/cms/icon_cms2.png" alt="" class="img-responsive" />
				<div class="txt_cms">
				<h2>Free Returns</h2>
				...
				<div class="col-cms col-xs-12 col-sm-6 col-md-6 col-lg-3">
				<div class="box_cms"><img src="/pos_ecolife/img/cms/icon_cms3.png" alt="" class="img-responsive" />
				<div class="txt_cms">
				...
				<div class="col-cms col-xs-12 col-sm-6 col-md-6 col-lg-3">
				<div class="box_cms"><img src="/pos_ecolife/img/cms/icon_cms4.png" alt="" class="img-responsive" />
				<div class="txt_cms">
				<h2>Support 24/7</h2>
				...
				<div class="banner-box"><a href="#"><img src="/pos_ecolife/img/cms/1_4.jpg" alt="" /></a></div>
				</div>
				<div class="col col-md-6 col-xs-12">
				<div class="banner-box"><a href="#"><img src="/pos_ecolife/img/cms/2_4.jpg" alt="" /></a></div>
				</div>
				<div class="col col-md-3 col-xs-12">
				<div class="banner-box"><a href="#"><img src="/pos_ecolife/img/cms/3_4.jpg" alt="" /></a></div>
				</div>
				</div>
				</div>\'),
				(4, '.(int)$lang['id_lang'].', \'<div class="home-banner">
				<div class="banner-box"><a href="#"><img src="/pos_ecolife/img/cms/4_1.jpg" alt="" /></a></div>
				</div>\')'
            ;
        }
