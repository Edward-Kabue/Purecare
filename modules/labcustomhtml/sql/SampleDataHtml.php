...
class SampleDataHtml
{
	public function initData($base_url)
	{
		$content_block1 = '
			...
			<div class="col-md-8">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_4_1.jpg" alt="images" /> </a></div>
			</div>
			<div class="col-md-4 ">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_4_2.jpg" alt="images" /> </a></div>
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_4_3.jpg" alt="images" /> </a></div>
			</div>
			</div>
			</div>
			<div class="laberStatic">
			<div class="row no-margin">
			<div class="col-md-3">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_4_4.jpg" alt="images" /> </a></div>
			</div>
			<div class="col-md-3">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_4_5.jpg" alt="images" /> </a></div>
			</div>
			<div class="col-md-6">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_4_6.jpg" alt="images" /> </a></div>
			</div>
			</div>
			</div>
		';
		...
		$content_block2 = '
			<div class="laber_text">
			<p>Free UK delivery - <span>Return over $100.00</span> ( Excluding Homeware )   |   Free UK collect from store</p>
			</div>
		';
		...
		$content_block3 = '
			...
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_1_3.jpg" alt="images" /> </a></div>
			</div>
			<div class=" col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_1_4.jpg" alt="images" /> </a></div>
			</div>
			</div>
			</div>
		';
		...
		$content_block4 = '
			...
			<div class="img"><a title="" href="#"> <img src="{static_block_url}/img/cms/img_1_5.jpg" alt="images" /> </a></div>
			</div>
		';
		...
		$result &= Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'labcustomhtml` (`id_labcustomhtml`, `hook`, `active`) 
			...
			(4, "displayPosition4", 1),
			(5, "displayPosition6", 1),
			(6, "displayLeftColumn", 1),
			(7, "displayFooter", 1),
			(8, "displayFooterAfter", 1),
			(9, "displayFooterAfter", 1)
		...
		foreach (Language::getLanguages(false) as $lang)
		{
			...
			( "4", "'.$id_shop.'","'.$lang['id_lang'].'","banner displayPosition4", \''.$content_block4.'\'),
			( "5", "'.$id_shop.'","'.$lang['id_lang'].'","support", \''.$content_block6.'\'),
			( "6", "'.$id_shop.'","'.$lang['id_lang'].'","Banner displayleftcolumn", \''.$content_block7.'\'),
			( "7", "'.$id_shop.'","'.$lang['id_lang'].'","logo footer and contac", \''.$content_block8.'\'),
			( "8", "'.$id_shop.'","'.$lang['id_lang'].'","Copyright", \''.$content_block9.'\'),
			( "9", "'.$id_shop.'","'.$lang['id_lang'].'","logo payment", \''.$content_block10.'\')
