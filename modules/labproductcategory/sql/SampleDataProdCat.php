...
class SampleDataProdCat
{
	public function initData()
	{
		...
		(1, "Group category2", "displayPosition4", "accordion", 16, 1, 1, 1),
		(2, "Group category3", "displayPosition5", "column", 16, 1, 1, 1),
		;');
		...
		(1, "Group category2", "'.$id_shop.'", "displayPosition4", "accordion", 16, 1, 1, 1),
		(2, "Group category3", "'.$id_shop.'", "displayPosition5", "column", 16, 1, 1, 1)
		;');
		...
		(3, 2, "'.$id_shop.'", 5, "", "", "false", 1, 0, 0, 1),
		(4, 2, "'.$id_shop.'", 6, "", "", "false", 1, 0, 0, 1)
		;');
