	...
	{		
		...
		$this->context->controller->getLanguages();
                ...
                foreach ($this->context->controller->_languages as $language){
                    $title[(int)$language['id_lang']] = 'Get Our Email Letter';
		...
		if (
			...
			|| Configuration::updateValue('LAB_WIDTH', 1091) == false
			|| Configuration::updateValue('LAB_HEIGHT', 484) == false
			|| Configuration::updateValue('LAB_NEWSLETTER', true) == false
			|| Configuration::updateValue('LAB_BG', true) == false
			|| Configuration::updateValue('LAB_BG_IMAGE',  _MODULE_DIR_.$this->name.'/img/background1.jpg') == false
                    )
			return false;
		return true;
	}
