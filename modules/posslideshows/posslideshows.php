        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					$slide->description[$language['id_lang']] = '{"1":{"title":"100% Natural","display":"3","animation":"6"},"2":{"title":"Fresh Vegetables","display":"0","animation":"7"},"3":{"title":"And Fruits","display":"0","animation":"8"},"4":{"title":"Shop Now","display":"5","animation":"10"}}';
				}elseif($i==2){
					$slide->title = 'slide show2';
					$slide->cap_position = 1;
					$slide->description[$language['id_lang']] = '{"1":{"title":"best offer sale !","display":"3","animation":"8"},"2":{"title":"Up To 70% Off","display":"0","animation":"9"},"3":{"title":"Fresh Juice","display":"0","animation":"7"},"4":{"title":"Shop Now","display":"5","animation":"10"}}'; 
				}else{
